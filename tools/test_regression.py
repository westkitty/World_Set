...
check("BACK-10: ShaderPreprocessor module", "const ShaderPreprocessor = {" in index_html, "Missing ShaderPreprocessor")
...
check("BACK-13: DynamicLODManager module", "const DynamicLODManager = {" in index_html, "Missing DynamicLODManager")
